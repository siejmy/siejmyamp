...
SiejmyAMP WordPress Theme, Copyright 2019-2020 WordPress.org
SiejmyAMP is distributed under the terms of the GNU GPL.
...
SiejmyAMP is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

SiejmyAMP bundles the following third-party resources:
...
Bespoke Icons Created For SiejmyAMP
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- siejmyamp_the_theme_svg()
- siejmyamp_get_theme_svg()
- siejmyamp_nav_menu_social_icons()
