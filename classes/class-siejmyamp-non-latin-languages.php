	...
	class TwentyTwenty_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'siejmyamp_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'siejmyamp_get_localized_font_family_elements',
				array(
			...
			return siejmyamp_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
