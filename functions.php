...
function siejmyamp_theme_support() {
	...
	if ( is_customize_preview() ) {
		...
		add_theme_support( 'starter-content', siejmyamp_get_starter_content() );
	}
 ...
 */
function siejmyamp_register_scripts() {
	...
	wp_enqueue_script( 'siejmyamp-js', get_template_directory_uri() . '/assets/js/index.js', array(), $theme_version, false );
	wp_script_add_data( 'siejmyamp-js', 'async', true );

}

add_action( 'wp_enqueue_scripts', 'siejmyamp_register_scripts' );
 ...
 */
function siejmyamp_skip_link_focus_fix() {
